...
func _init(simple_enemy_health = float(20), shooter_enemy_health = float(10), enemy_movement_speed = float(300), enemy_projectile_speed = float(500), enemy_shooting_speed = float(1.7), enemy_projectile_damage = float(5), enemy_melee_damage = float(2), spawn_enemy_time = float(1.2), round_time = int(20)):
